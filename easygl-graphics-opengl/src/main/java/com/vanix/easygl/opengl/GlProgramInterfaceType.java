...
public enum GlProgramInterfaceType implements IntEnum {
    ...
    final Class<? extends ProgramResource<?>> resourceType;
    ...
    GlProgramInterfaceType(int value, Class<? extends BaseInterface<?>> interfaceType, BiFunction<Program, GlProgramInterfaceType, ? extends BaseInterface<?>> factory) {
        ...
        resourceType = (Class<? extends ProgramResource<?>>) TypeUtils.getTypeArguments(interfaceType, ProgramInterface.class)
    ...
    public Class<? extends ProgramResource<?>> resourceType() {
        return resourceType;
    }
}
